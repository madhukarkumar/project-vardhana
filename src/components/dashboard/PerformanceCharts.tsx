...
const leadsData = Array.from({ length: 30 }, (_, i) => {
  const date = new Date();
  date.setDate(date.getDate() - (29 - i)); // Count backwards from today
  return {
    date: date.toISOString().split('T')[0],
    leads: Math.floor(Math.random() * (80 - 30) + 30), // Random value between 30-80
  };
});
          ...
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={leadsData} barSize={8}>
              ...
              <XAxis 
                ...
                interval={4} // Show every 5th tick to avoid crowding
              />
